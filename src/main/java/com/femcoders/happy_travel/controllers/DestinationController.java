...
public class DestinationController {
    ...
    @Operation(
            summary = "Get destinations of the authenticated user // Accessible by any authenticated user"
    )
    ...
    @Operation(
            summary = "Get destinations by specific user ID // Accessible by OWNER and ADMIN"
    ...
    @Operation(
            summary = "Create a new destination // Accessible by OWNER and ADMIN"
    )
    ...
    @Operation(
            summary = "Get all destinations by title or location // Public endpoint"
    )
    ...
    @Operation(
            summary = "Get a destination by ID // Public endpoint"
    ...
    @Operation(
            summary = "Update an existing destination // Accessible by OWNER and ADMIN"
    )
    ...
    @Operation(
            summary = "Delete a destination // Accessible by OWNER and ADMIN"
    )
    ...
    @Operation(
            summary = "Get paginated destinations // Public endpoint"
    )
    @Parameters({
